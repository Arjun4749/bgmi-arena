    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-20 bg-grid relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-neutral-400 mt-2">Sign in to continue to the arena</p>
        </div>
        ...
        <Card className="p-7">
          <form onSubmit={handleEmailLogin} className="space-y-5">
            ...
            <div className="flex items-center justify-between text-sm">
              <button type="button" onClick={() => navigate('/forgot-password')} className="text-accent-400 hover:text-accent-300">
                Forgot password?
              </button>
            </div>
        ...
        <p className="text-center text-sm text-neutral-400 mt-6">
          New here? <button onClick={() => navigate('/signup')} className="text-primary-400 font-semibold hover:text-primary-300">Create an account</button>
        </p>
      </div>
    </div>
  );
